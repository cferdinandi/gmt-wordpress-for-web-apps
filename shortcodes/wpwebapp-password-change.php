		...
		if ( is_user_logged_in() ) {
			...
			$form =
				...
				'<form class="wpwebapp-form" id="wpwebapp_password_change" name="wpwebapp_password_change" action="" method="post">' .
					...
					'<input type="password" class="wpwebapp-form-input" id="wpwebapp_password_change_current_password" name="wpwebapp_password_change_current_password"  value="" required>' .
					...
					'<input type="password" class="wpwebapp-form-input" id="wpwebapp_password_change_new_password" name="wpwebapp_password_change_new_password"  value="" required>' .
