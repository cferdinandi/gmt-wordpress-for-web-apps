 ...
 */
	...
	function wpwebapp_settings_field_signup_form_labels() {
		...
		?>
		<div>
			<input type="text" name="wpwebapp_theme_options_signup[signup_username_label]" id="signup_username_label" value="<?php echo stripslashes( esc_attr( $options['signup_username_label'] ) ); ?>" />
			<label class="description" for="signup_username_label"><?php _e( 'Sign up form "Username" field label', 'wpwebapp' ); ?></label>
		</div>

		<div>
			<input type="text" name="wpwebapp_theme_options_signup[signup_email_label]" id="signup_email_label" value="<?php echo stripslashes( esc_attr( $options['signup_email_label'] ) ); ?>" />
			<label class="description" for="signup_email_label"><?php _e( 'Sign up form "Email" field label', 'wpwebapp' ); ?></label>
		</div>

		<div>
			<input type="text" name="wpwebapp_theme_options_signup[signup_password_label]" id="signup_password_label" value="<?php echo stripslashes( esc_attr( $options['signup_password_label'] ) ); ?>" />
	...
	function wpwebapp_settings_field_signup_form_submit() {
		...
		?>
		<div>
			<input type="text" name="wpwebapp_theme_options_signup[signup_submit_text]" id="signup_submit_text" value="<?php echo esc_attr( $options['signup_submit_text'] ); ?>" />
	...
	function wpwebapp_settings_field_signup_form_show_requirements() {
		...
		<div>
			<label>
				<input type="checkbox" name="wpwebapp_theme_options_signup[signup_show_requirements]" id="signup_show_requirements" value="on" <?php checked( $options['signup_show_requirements'], 'on' ); ?>>
	...
	function wpwebapp_settings_field_signup_form_errors() {
		...
		?>
		<div>
			<input type="text" name="wpwebapp_theme_options_signup[signup_username_field_empty_error]" class="large-text" id="signup_username_field_empty_error" value="<?php echo stripslashes( esc_attr( $options['signup_username_field_empty_error'] ) ); ?>" />
		...
		<div>
			<input type="text" name="wpwebapp_theme_options_signup[signup_email_field_empty_error]" class="large-text" id="signup_email_field_empty_error" value="<?php echo stripslashes( esc_attr( $options['signup_email_field_empty_error'] ) ); ?>" />
		...
		<div>
			<input type="text" name="wpwebapp_theme_options_signup[signup_password_field_empty_error]" class="large-text" id="signup_password_field_empty_error" value="<?php echo stripslashes( esc_attr( $options['signup_password_field_empty_error'] ) ); ?>" />
		...
		<div>
			<input type="text" name="wpwebapp_theme_options_signup[signup_username_invalid_error]" class="large-text" id="signup_username_invalid_error" value="<?php echo stripslashes( esc_attr( $options['signup_username_invalid_error'] ) ); ?>" />
		...
		<div>
			<input type="text" name="wpwebapp_theme_options_signup[signup_username_exists_error]" class="large-text" id="signup_username_exists_error" value="<?php echo stripslashes( esc_attr( $options['signup_username_exists_error'] ) ); ?>" />
		...
		<div>
			<input type="text" name="wpwebapp_theme_options_signup[signup_email_invalid_error]" class="large-text" id="signup_email_invalid_error" value="<?php echo stripslashes( esc_attr( $options['signup_email_invalid_error'] ) ); ?>" />
		...
		<div>
			<input type="text" name="wpwebapp_theme_options_signup[signup_email_exists_error]" class="large-text" id="signup_email_exists_error" value="<?php echo stripslashes( esc_attr( $options['signup_email_exists_error'] ) ); ?>" />
		...
		<div>
			<input type="text" name="wpwebapp_theme_options_signup[signup_login_failed_error]" class="large-text" id="signup_login_failed_error" value="<?php echo stripslashes( esc_attr( $options['signup_login_failed_error'] ) ); ?>" />
	...
	function wpwebapp_settings_field_signup_form_notifications_to_admin() {
		...
		<div>
			<label for="signup_receive_notifications">
				<input type="checkbox" name="wpwebapp_theme_options_signup[signup_receive_notifications]" id="signup_receive_notifications" <?php checked( 'on', $options['signup_receive_notifications'] ); ?> />
		...
		<div>
			<textarea name="wpwebapp_theme_options_signup[signup_notification_to_admin]" class="large-text" id="signup_notification_to_admin" cols="50" rows="10"><?php echo stripslashes( esc_textarea( $options['signup_notification_to_admin'] ) ); ?></textarea>
	...
	function wpwebapp_settings_field_signup_form_notifications_to_user() {
		...
		<div>
			<label for="signup_send_notifications">
				<input type="checkbox" name="wpwebapp_theme_options_signup[signup_send_notifications]" id="signup_send_notifications" <?php checked( 'on', $options['signup_send_notifications'] ); ?> />
		...
		<div>
			<textarea name="wpwebapp_theme_options_signup[signup_notification_to_user]" class="large-text" id="signup_notification_to_user" cols="50" rows="10"><?php echo stripslashes( esc_textarea( $options['signup_notification_to_user'] ) ); ?></textarea>
	...
	function wpwebapp_settings_field_create_user_password_time_limit() {
		...
		?>
		<div>
			<input type="number" min="1" name="wpwebapp_theme_options_signup[create_user_password_time_valid]" class="small-text" id="create_user_password_time_valid" value="<?php echo esc_attr( $options['create_user_password_time_valid'] ); ?>" />
	...
	function wpwebapp_settings_field_create_user_notifications_to_user() {
		...
		<div>
			<label for="create_user_send_notifications">
				<input type="checkbox" name="wpwebapp_theme_options_signup[create_user_send_notifications]" id="create_user_send_notifications" <?php checked( 'on', $options['create_user_send_notifications'] ); ?> />
		...
		<div>
			<textarea name="wpwebapp_theme_options_signup[create_user_notification]" class="large-text" id="create_user_notification" cols="50" rows="10"><?php echo stripslashes( esc_textarea( $options['create_user_notification'] ) ); ?></textarea>
	...
	function wpwebapp_settings_field_login_form_labels() {
		...
		?>
		<div>
			<input type="text" name="wpwebapp_theme_options_login[login_username_label]" id="login_username_label" value="<?php echo stripslashes( esc_attr( $options['login_username_label'] ) ); ?>" />
			<label class="description" for="login_username_label"><?php _e( 'Login form "Username" label', 'wpwebapp' ); ?></label>
		</div>

		<div>
			<input type="text" name="wpwebapp_theme_options_login[login_password_label]" id="login_password_label" value="<?php echo stripslashes( esc_attr( $options['login_password_label'] ) ); ?>" />
			<label class="description" for="login_password_label"><?php _e( 'Login form "Password" label', 'wpwebapp' ); ?></label>
		</div>

		<div>
			<input type="text" name="wpwebapp_theme_options_login[login_rememberme_label]" id="login_rememberme_label" value="<?php echo stripslashes( esc_attr( $options['login_rememberme_label'] ) ); ?>" />
	...
	function wpwebapp_settings_field_login_form_submit() {
		...
		?>
		<div>
			<input type="text" name="wpwebapp_theme_options_login[login_submit_text]" id="login_submit_text" value="<?php echo esc_attr( $options['login_submit_text'] ); ?>" />
	...
	function wpwebapp_settings_field_login_form_errors() {
		...
		?>
		<div>
			<input type="text" name="wpwebapp_theme_options_login[login_username_field_empty_error]" class="large-text" id="login_username_field_empty_error" value="<?php echo stripslashes( esc_attr( $options['login_username_field_empty_error'] ) ); ?>" />
		...
		<div>
			<input type="text" name="wpwebapp_theme_options_login[login_password_field_empty_error]" class="large-text" id="login_password_field_empty_error" value="<?php echo stripslashes( esc_attr( $options['login_password_field_empty_error'] ) ); ?>" />
		...
		<div>
			<input type="text" name="wpwebapp_theme_options_login[login_failed_error]" class="large-text" id="login_failed_error" value="<?php echo stripslashes( esc_attr( $options['login_failed_error'] ) ); ?>" />
	...
	function wpwebapp_settings_field_login_logout_redirects() {
		...
		<div>
			...
			<select name="wpwebapp_theme_options_redirects[login_redirect]" id="login_redirect" >
		...
		<div>
			...
			<select name="wpwebapp_theme_options_redirects[password_reset_redirect]" id="password_reset_redirect">
		...
		<div>
			<label class="description">
				<input type="checkbox" name="wpwebapp_theme_options_redirects[add_redirect_referrer]" id="add_redirect_referrer" value="on" <?php checked( $options['add_redirect_referrer'], 'on' ); ?>>
	...
	function wpwebapp_settings_field_email_change_form_labels() {
		...
		?>
		<div>
			<input type="text" name="wpwebapp_theme_options_change_email[email_change_current_email_label]" id="email_change_current_email_label" value="<?php echo stripslashes( esc_attr( $options['email_change_current_email_label'] ) ); ?>" />
			<label class="description" for="email_change_current_email_label"><?php _e( 'Change email form "Email" label', 'wpwebapp' ); ?></label>
		</div>

		<div>
			<input type="text" name="wpwebapp_theme_options_change_email[email_change_password_label]" id="email_change_password_label" value="<?php echo stripslashes( esc_attr( $options['email_change_password_label'] ) ); ?>" />
	...
	function wpwebapp_settings_field_email_change_form_submit() {
		...
		?>
		<div>
			<input type="text" name="wpwebapp_theme_options_change_email[email_change_submit_text]" id="email_change_submit_text" value="<?php echo esc_attr( $options['email_change_submit_text'] ); ?>" />
	...
	function wpwebapp_settings_field_email_change_form_errors() {
		...
		?>
		<div>
			<input type="text" name="wpwebapp_theme_options_change_email[email_change_email_field_empty_error]" class="large-text" id="email_change_email_field_empty_error" value="<?php echo stripslashes( esc_attr( $options['email_change_email_field_empty_error'] ) ); ?>" />
		...
		<div>
			<input type="text" name="wpwebapp_theme_options_change_email[email_change_password_field_empty_error]" class="large-text" id="email_change_password_field_empty_error" value="<?php echo stripslashes( esc_attr( $options['email_change_password_field_empty_error'] ) ); ?>" />
		...
		<div>
			<input type="text" name="wpwebapp_theme_options_change_email[email_change_password_error]" class="large-text" id="email_change_password_error" value="<?php echo stripslashes( esc_attr( $options['email_change_password_error'] ) ); ?>" />
		...
		<div>
			<input type="text" name="wpwebapp_theme_options_change_email[email_change_success]" class="large-text" id="email_change_success" value="<?php echo stripslashes( esc_attr( $options['email_change_success'] ) ); ?>" />
	...
	function wpwebapp_settings_field_password_change_form_labels() {
		...
		?>
		<div>
			<input type="text" name="wpwebapp_theme_options_change_password[password_change_current_password_label]" id="password_change_current_password_label" value="<?php echo stripslashes( esc_attr( $options['password_change_current_password_label'] ) ); ?>" />
		...
		<div>
			<input type="text" name="wpwebapp_theme_options_change_password[password_change_new_password_label]" id="password_change_new_password_label" value="<?php echo stripslashes( esc_attr( $options['password_change_new_password_label'] ) ); ?>" />
	...
	function wpwebapp_settings_field_password_change_form_submit() {
		...
		?>
		<div>
			<input type="text" name="wpwebapp_theme_options_change_password[password_change_submit_text]" id="password_change_submit_text" value="<?php echo esc_attr( $options['password_change_submit_text'] ); ?>" />
	...
	function wpwebapp_settings_field_password_change_form_show_requirements() {
		...
		<div>
			<label>
				<input type="checkbox" name="wpwebapp_theme_options_change_password[password_change_show_requirements]" id="password_change_show_requirements" value="on" <?php checked( $options['password_change_show_requirements'], 'on' ); ?>>
	...
	function wpwebapp_settings_field_password_change_form_errors() {
		...
		?>
		<div>
			<input type="text" name="wpwebapp_theme_options_change_password[password_change_forced_reset_error]" class="large-text" id="password_change_forced_reset_error" value="<?php echo stripslashes( esc_attr( $options['password_change_forced_reset_error'] ) ); ?>" />
		...
		<div>
			<input type="text" name="wpwebapp_theme_options_change_password[password_change_current_password_field_empty_error]" class="large-text" id="password_change_current_password_field_empty_error" value="<?php echo stripslashes( esc_attr( $options['password_change_current_password_field_empty_error'] ) ); ?>" />
		...
		<div>
			<input type="text" name="wpwebapp_theme_options_change_password[password_change_new_password_field_empty_error]" class="large-text" id="password_change_new_password_field_empty_error" value="<?php echo stripslashes( esc_attr( $options['password_change_new_password_field_empty_error'] ) ); ?>" />
		...
		<div>
			<input type="text" name="wpwebapp_theme_options_change_password[password_change_password_error]" class="large-text" id="password_change_password_error" value="<?php echo stripslashes( esc_attr( $options['password_change_password_error'] ) ); ?>" />
		...
		<div>
			<input type="text" name="wpwebapp_theme_options_change_password[password_change_success]" class="large-text" id="password_change_success" value="<?php echo stripslashes( esc_attr( $options['password_change_success'] ) ); ?>" />
	...
	function wpwebapp_settings_field_password_change_form_notifications_to_admin() {
		...
		<div>
			<label for="password_change_receive_notifications">
				<input type="checkbox" name="wpwebapp_theme_options_change_password[password_change_receive_notifications]" id="password_change_receive_notifications" <?php checked( 'on', $options['password_change_receive_notifications'] ); ?> />
		...
		<div>
			<textarea name="wpwebapp_theme_options_change_password[password_change_notification_to_admin]" class="large-text" id="password_change_notification_to_admin" cols="50" rows="10"><?php echo stripslashes( esc_textarea( $options['password_change_notification_to_admin'] ) ); ?></textarea>
	...
	function wpwebapp_settings_field_password_change_form_notifications_to_user() {
		...
		<div>
			<label for="password_change_send_notifications">
				<input type="checkbox" name="wpwebapp_theme_options_change_password[password_change_send_notifications]" id="password_change_send_notifications" <?php checked( 'on', $options['password_change_send_notifications'] ); ?> />
		...
		<div>
			<textarea name="wpwebapp_theme_options_change_password[password_change_notification_to_user]" class="large-text" id="password_change_notification_to_user" cols="50" rows="10"><?php echo stripslashes( esc_textarea( $options['password_change_notification_to_user'] ) ); ?></textarea>
	...
	function wpwebapp_settings_field_password_reset_url() {
		...
		<div>
			...
			<select name="wpwebapp_theme_options_forgot_password[password_reset_url]" id="password_reset_url">
	...
	function wpwebapp_settings_field_password_reset_form_labels() {
		...
		?>
		<div>
			<input type="text" name="wpwebapp_theme_options_forgot_password[password_forgot_label]" id="password_forgot_label" value="<?php echo stripslashes( esc_attr( $options['password_forgot_label'] ) ); ?>" />
			<label class="description" for="password_forgot_label"><?php _e( 'Forgot password form "Username" label', 'wpwebapp' ); ?></label>
		</div>

		<div>
			<input type="text" name="wpwebapp_theme_options_forgot_password[password_reset_label]" id="password_reset_label" value="<?php echo stripslashes( esc_attr( $options['password_reset_label'] ) ); ?>" />
	...
	function wpwebapp_settings_field_password_reset_form_submit() {
		...
		?>
		<div>
			<input type="text" name="wpwebapp_theme_options_forgot_password[password_forgot_submit_text]" id="password_forgot_submit_text" value="<?php echo esc_attr( $options['password_forgot_submit_text'] ); ?>" />
			<label class="description" for="password_forgot_submit_text"><?php _e( 'Forgot password form "Submit" button text', 'wpwebapp' ); ?></label>
		</div>

		<div>
			<input type="text" name="wpwebapp_theme_options_forgot_password[password_reset_submit_text]" id="password_reset_submit_text" value="<?php echo esc_attr( $options['password_reset_submit_text'] ); ?>" />
			<label class="description" for="password_reset_submit_text"><?php _e( 'Reset password form "Submit" button text', 'wpwebapp' ); ?></label>
		</div>
		<?php
	}

	// Forgot password form show requirements
	function wpwebapp_settings_field_password_reset_form_show_requirements() {
		$options = wpwebapp_get_theme_options_forgot_password();
		?>
		<div>
			<label>
				<input type="checkbox" name="wpwebapp_theme_options_forgot_password[password_reset_show_requirements]" id="password_reset_show_requirements" value="on" <?php checked( $options['password_reset_show_requirements'], 'on' ); ?>>
	...
	function wpwebapp_settings_field_password_reset_form_errors() {
		...
		?>
		<div>
			<input type="text" name="wpwebapp_theme_options_forgot_password[password_forgot_password_field_empty_error]" class="large-text" id="password_forgot_password_field_empty_error" value="<?php echo stripslashes( esc_attr( $options['password_forgot_password_field_empty_error'] ) ); ?>" />
		...
		<div>
			<input type="text" name="wpwebapp_theme_options_forgot_password[password_forgot_password_invalid_user_error]" class="large-text" id="password_forgot_password_invalid_user_error" value="<?php echo stripslashes( esc_attr( $options['password_forgot_password_invalid_user_error'] ) ); ?>" />
		...
		<div>
			<input type="text" name="wpwebapp_theme_options_forgot_password[password_forgot_password_is_admin_error]" class="large-text" id="password_forgot_password_is_admin_error" value="<?php echo stripslashes( esc_attr( $options['password_forgot_password_is_admin_error'] ) ); ?>" />
		...
		<div>
			<input type="text" name="wpwebapp_theme_options_forgot_password[password_forgot_password_email_error]" class="large-text" id="password_forgot_password_email_error" value="<?php echo stripslashes( esc_attr( $options['password_forgot_password_email_error'] ) ); ?>" />
		...
		<div>
			<input type="text" name="wpwebapp_theme_options_forgot_password[password_forgot_password_reset_key_expired_error]" class="large-text" id="password_forgot_password_reset_key_expired_error" value="<?php echo stripslashes( esc_attr( $options['password_forgot_password_reset_key_expired_error'] ) ); ?>" />
		...
		<div>
			<input type="text" name="wpwebapp_theme_options_forgot_password[password_forgot_password_success]" class="large-text" id="password_forgot_password_success" value="<?php echo stripslashes( esc_attr( $options['password_forgot_password_success'] ) ); ?>" />
		...
		<div>
			<input type="text" name="wpwebapp_theme_options_forgot_password[password_reset_password_field_empty_error]" class="large-text" id="password_reset_password_field_empty_error" value="<?php echo stripslashes( esc_attr( $options['password_reset_password_field_empty_error'] ) ); ?>" />
	...
	function wpwebapp_settings_field_password_reset_time_limit() {
		...
		?>
		<div>
			<input type="number" min="1" name="wpwebapp_theme_options_forgot_password[password_reset_time_valid]" class="small-text" id="password_reset_time_valid" value="<?php echo esc_attr( $options['password_reset_time_valid'] ); ?>" />
	...
	function wpwebapp_settings_field_password_reset_notification_email() {
		...
		?>
		<div>
			<textarea name="wpwebapp_theme_options_forgot_password[password_reset_notification_email]" class="large-text" id="password_reset_notification_email" cols="50" rows="10"><?php echo stripslashes( esc_textarea( $options['password_reset_notification_email'] ) ); ?></textarea>
	...
	function wpwebapp_settings_field_delete_account_form_labels() {
		...
		?>
		<div>
			<input type="text" name="wpwebapp_theme_options_delete_account[delete_account_password_label]" id="delete_account_password_label" value="<?php echo stripslashes( esc_attr( $options['delete_account_password_label'] ) ); ?>" />
	...
	function wpwebapp_settings_field_delete_account_form_submit() {
		...
		?>
		<div>
			<input type="text" name="wpwebapp_theme_options_delete_account[delete_account_submit_text]" id="delete_account_submit_text" value="<?php echo esc_attr( $options['delete_account_submit_text'] ); ?>" />
	...
	function wpwebapp_settings_field_delete_account_form_errors() {
		...
		?>
		<div>
			<input type="text" name="wpwebapp_theme_options_delete_account[delete_account_password_error]" class="large-text" id="delete_account_password_error" value="<?php echo stripslashes( esc_attr( $options['delete_account_password_error'] ) ); ?>" />
	...
	function wpwebapp_settings_field_delete_account_form_redirect_url() {
		...
		<div>
			...
			<select name="wpwebapp_theme_options_delete_account[delete_account_redirect]" id="delete_account_redirect" >
	...
	function wpwebapp_settings_field_password_length_requirements() {
		...
		?>
		<div>
			<input type="number" min="2" name="wpwebapp_theme_options_security[password_minimum_length]" class="small-text" id="password_minimum_length" value="<?php echo esc_attr( $options['password_minimum_length'] ); ?>" />
	...
	function wpwebapp_settings_field_password_character_requirements() {
		...
		<div>
			<label>
				<input type="checkbox" name="wpwebapp_theme_options_security[password_requires_letters]" id="password_requires_letters" <?php checked( 'on', $options['password_requires_letters'] ); ?> />
				<?php _e( 'Require passwords to contain at least 1 letter (if mixed-case is required, this will also be required)', 'wpwebapp' ); ?>
			</label>
		</div>
		<div>
			<label>
				<input type="checkbox" name="wpwebapp_theme_options_security[password_requires_numbers]" id="password_requires_numbers" <?php checked( 'on', $options['password_requires_numbers'] ); ?> />
				<?php _e( 'Require passwords to contain at least 1 number', 'wpwebapp' ); ?>
			</label>
		</div>
		<div>
			<label>
				<input type="checkbox" name="wpwebapp_theme_options_security[password_requires_special_characters]" id="password_requires_special_characters" <?php checked( 'on', $options['password_requires_special_characters'] ); ?> />
				<?php _e( 'Require passwords to contain at least 1 special character', 'wpwebapp' ); ?>
			</label>
		</div>
		<div>
			<label>
				<input type="checkbox" name="wpwebapp_theme_options_security[password_requires_mixed_case]" id="password_requires_mixed_case" <?php checked( 'on', $options['password_requires_mixed_case'] ); ?> />
	...
	function wpwebapp_settings_field_show_admin_bar() {
		...
		<div>
			<label>
				<input type="checkbox" name="wpwebapp_theme_options_security[show_admin_bar]" id="show_admin_bar" <?php checked( 'on', $options['show_admin_bar'] ); ?> />
	...
	function wpwebapp_get_theme_options_signup() {
		$saved = (array) get_option( 'wpwebapp_theme_options_signup' );
		$defaults = array(
			'signup_username_label' => __( 'Username', 'wpwebapp' ),
			'signup_email_label' => __( 'Email', 'wpwebapp' ),
			'signup_password_label' => __( 'Password', 'wpwebapp' ),
			'signup_submit_text' => __( 'Sign Up', 'wpwebapp' ),
			'signup_show_requirements' => 'off',
			'signup_username_field_empty_error' => __( 'Please enter a username.', 'wpwebapp' ),
			'signup_email_field_empty_error' => __( 'Please enter an email address.', 'wpwebapp' ),
			'signup_password_field_empty_error' => __( 'Please enter a password.', 'wpwebapp' ),
			'signup_username_invalid_error' => __( 'Usernames can only contain letters, numbers, and these special characters: _, space, ., -, *, and @.', 'wpwebapp' ),
		...
		$defaults = apply_filters( 'wpwebapp_default_theme_options_signup', $defaults );
	...
	function wpwebapp_get_theme_options_login() {
		$saved = (array) get_option( 'wpwebapp_theme_options_login' );
		$defaults = array(
			'login_username_label' => __( 'Username or Email', 'wpwebapp' ),
			'login_password_label' => __( 'Password', 'wpwebapp' ),
			'login_rememberme_label' => __( 'Remember me', 'wpwebapp' ),
			'login_submit_text' =>  __( 'Login', 'wpwebapp' ),
			'login_username_field_empty_error' => __( 'Please enter a username or email address.', 'wpwebapp' ),
			'login_password_field_empty_error' => __( 'Please enter your password.', 'wpwebapp' ),
			'login_failed_error' => __( 'Login failed. Please try again.', 'wpwebapp' ),
		);

		$defaults = apply_filters( 'wpwebapp_default_theme_options_login', $defaults );
	...
	function wpwebapp_get_theme_options_redirects() {
		$saved = (array) get_option( 'wpwebapp_theme_options_redirects' );
		$defaults = array(
			'login_redirect' => '0',
			'logout_redirect' => '0',
		...
		$defaults = apply_filters( 'wpwebapp_default_theme_options_redirects', $defaults );
	...
	function wpwebapp_get_theme_options_change_email() {
		$saved = (array) get_option( 'wpwebapp_theme_options_change_email' );
		$defaults = array(
			'email_change_current_email_label' => __( 'Email', 'wpwebapp' ),
			'email_change_password_label' => __( 'Password', 'wpwebapp' ),
			'email_change_submit_text' =>  __( 'Change My Email', 'wpwebapp' ),
			'email_change_email_field_empty_error' => __( 'Please enter a new email address.', 'wpwebapp' ),
			'email_change_password_field_empty_error' => __( 'Please enter your password.', 'wpwebapp' ),
			'email_change_password_error' => __( 'The password you provided is not correct.', 'wpwebapp' ),
			'email_change_success' => __( 'Your email address was updated.', 'wpwebapp' ),
		);

		$defaults = apply_filters( 'wpwebapp_default_theme_options_change_email', $defaults );
	...
	function wpwebapp_get_theme_options_change_password() {
		$saved = (array) get_option( 'wpwebapp_theme_options_change_password' );
		$defaults = array(
			'password_change_current_password_label' => __( 'Current Password', 'wpwebapp' ),
			'password_change_new_password_label' => __( 'New Password', 'wpwebapp' ),
			'password_change_submit_text' => __( 'Change My Password', 'wpwebapp' ),
			'password_change_show_requirements' => 'off',
			'password_change_forced_reset_error' => __(' You must change your password before you can continue.', 'wpwebapp' ),
			'password_change_current_password_field_empty_error' => __( 'Please enter your current password.', 'wpwebapp' ),
			'password_change_new_password_field_empty_error' => __( 'Please enter a new password.', 'wpwebapp' ),
			'password_change_password_error' => __( 'The current password you provided is not correct.', 'wpwebapp' ),
			'password_change_success' => __( 'Your password was updated.', 'wpwebapp' ),
		...
		$defaults = apply_filters( 'wpwebapp_default_theme_options_change_password', $defaults );
	...
	function wpwebapp_get_theme_options_forgot_password() {
		$saved = (array) get_option( 'wpwebapp_theme_options_forgot_password' );
		$defaults = array(
			'password_reset_url' => '',
			'password_forgot_label' => __( 'Username or Email', 'wpwebapp' ),
			'password_forgot_submit_text' => __( 'Reset My Password', 'wpwebapp' ),
			'password_reset_label' => __( 'New Password', 'wpwebapp' ),
			'password_reset_submit_text' => __( 'Update My Password', 'wpwebapp' ),
			'password_reset_show_requirements' => 'off',
			'password_forgot_password_field_empty_error' => __( 'Please enter your username or email.', 'wpwebapp' ),
			'password_forgot_password_invalid_user_error' => __( 'The username or email your entered does not exist.', 'wpwebapp' ),
			'password_forgot_password_is_admin_error' => __( 'This user\'s password cannot be reset.', 'wpwebapp' ),
			'password_forgot_password_email_error' => __( 'Password reset failed. Please try again.', 'wpwebapp' ),
			'password_forgot_password_reset_key_expired_error' => __( 'This link has expired. Please try again.', 'wpwebapp' ),
			'password_forgot_password_success' => __( 'An email has been sent to you with a password reset link.', 'wpwebapp' ),
			'password_reset_password_field_empty_error' => __( 'Please enter a new password.', 'wpwebapp' ),
		...
		$defaults = apply_filters( 'wpwebapp_default_theme_options_forgot_password', $defaults );
	...
	function wpwebapp_get_theme_options_delete_account() {
		$saved = (array) get_option( 'wpwebapp_theme_options_delete_account' );
		$defaults = array(
			'delete_account_password_label' => __( 'Confirm Password', 'wpwebapp' ),
			'delete_account_submit_text' =>  __( 'Delete My Account', 'wpwebapp' ),
			'delete_account_password_error' => __( 'The password you provided is not correct.', 'wpwebapp' ),
			'delete_account_redirect' => '0',
		);

		$defaults = apply_filters( 'wpwebapp_default_theme_options_delete_account', $defaults );
	...
	function wpwebapp_get_theme_options_security() {
		$saved = (array) get_option( 'wpwebapp_theme_options_security' );
		$defaults = array(
		...
		$defaults = apply_filters( 'wpwebapp_default_theme_options_security', $defaults );
	...
	function wpwebapp_theme_options_validate_signup( $input ) {
		$output = array();
		...
		return apply_filters( 'wpwebapp_theme_options_validate_signup', $output, $input );
	}

	function wpwebapp_theme_options_validate_login( $input ) {
		$output = array();
		...
		return apply_filters( 'wpwebapp_theme_options_validate_login', $output, $input );
	}

	function wpwebapp_theme_options_validate_redirects( $input ) {
		$output = array();
		...
		return apply_filters( 'wpwebapp_theme_options_validate_redirects', $output, $input );
	}

	function wpwebapp_theme_options_validate_change_email( $input ) {
		$output = array();
		...
		return apply_filters( 'wpwebapp_theme_options_validate_change_email', $output, $input );
	}

	function wpwebapp_theme_options_validate_change_password( $input ) {
		$output = array();
		...
		return apply_filters( 'wpwebapp_theme_options_validate_change_password', $output, $input );
	}

	function wpwebapp_theme_options_validate_forgot_password( $input ) {
		$output = array();
		...
		return apply_filters( 'wpwebapp_theme_options_validate_forgot_password', $output, $input );
	}

	function wpwebapp_theme_options_validate_delete_account( $input ) {
		$output = array();
		...
		return apply_filters( 'wpwebapp_theme_options_validate_delete_account', $output, $input );
	}

	function wpwebapp_theme_options_validate_security( $input ) {
		$output = array();
		...
		return apply_filters( 'wpwebapp_theme_options_validate_security', $output, $input );
	}
	...
	function wpwebapp_theme_options_page_tabs() {
		$tabs = array(
			'signup' => __( 'Sign Up', 'wpwebapps' ),
			'login' => __( 'Login', 'wpwebapps' ),
			'redirects' => __( 'Redirects', 'wpwebapps' ),
			'change_email' => __( 'Change Email', 'wpwebapps' ),
			'change_password' => __( 'Change Password', 'wpwebapps' ),
			'forgot_password' => __( 'Forgot Password', 'wpwebapps' ),
			'delete_account' => __( 'Delete Account', 'wpwebapps' ),
			'security' => __( 'Security', 'wpwebapps' ),
		);

		return apply_filters( 'wpwebapp_theme_options_page_tabs', $tabs );
	}
	...
	function wpwebapp_theme_options_render_page() {
		...
		<div class="wrap">
			...
			<?php // settings_errors(); ?>
			<?php $active_tab = isset( $_GET['tab'] ) ? $_GET['tab'] : 'signup'; ?>

			<h2 class="nav-tab-wrapper">
				<?php foreach( wpwebapp_theme_options_page_tabs() as $key => $tab ) : ?>
					<a class="nav-tab <?php if ( $active_tab === $key ) { echo 'nav-tab-active'; } ?>" href="options-general.php?page=wpwebapp_plugin_options&tab=<?php echo $key; ?>">
						<?php echo $tab; ?>
					</a>
				<?php endforeach; ?>
			</h2>
			...
			<form method="post" action="options.php">
				<?php
					settings_fields( 'wpwebapp_options_' . $active_tab );
					do_settings_sections( 'wpwebapp_options_' . $active_tab );
					submit_button();
				?>
			</form>
		</div>
	...
	function wpwebapp_theme_options_init() {
		...
		register_setting( 'wpwebapp_options_signup', 'wpwebapp_theme_options_signup', 'wpwebapp_theme_options_validate_signup' );
		register_setting( 'wpwebapp_options_login', 'wpwebapp_theme_options_login', 'wpwebapp_theme_options_validate_login' );
		register_setting( 'wpwebapp_options_redirects', 'wpwebapp_theme_options_redirects', 'wpwebapp_theme_options_validate_redirects' );
		register_setting( 'wpwebapp_options_change_email', 'wpwebapp_theme_options_change_email', 'wpwebapp_theme_options_validate_change_email' );
		register_setting( 'wpwebapp_options_change_password', 'wpwebapp_theme_options_change_password', 'wpwebapp_theme_options_validate_change_password' );
		register_setting( 'wpwebapp_options_forgot_password', 'wpwebapp_theme_options_forgot_password', 'wpwebapp_theme_options_validate_forgot_password' );
		register_setting( 'wpwebapp_options_delete_account', 'wpwebapp_theme_options_delete_account', 'wpwebapp_theme_options_validate_delete_account' );
		register_setting( 'wpwebapp_options_security', 'wpwebapp_theme_options_security', 'wpwebapp_theme_options_validate_security' );
		...
		add_settings_section( 'signup', 'Sign Up Form',  '__return_false', 'wpwebapp_options_signup' );
		add_settings_section( 'login', 'Login Form',  '__return_false', 'wpwebapp_options_login' );
		add_settings_section( 'redirects', 'Redirects',  '__return_false', 'wpwebapp_options_redirects' );
		add_settings_section( 'email_change', 'Change Email Form',  '__return_false', 'wpwebapp_options_change_email' );
		add_settings_section( 'password_change', 'Change Password Form',  '__return_false', 'wpwebapp_options_change_password' );
		add_settings_section( 'password_forgot', 'Forgot Password Form',  '__return_false', 'wpwebapp_options_forgot_password' );
		add_settings_section( 'delete_account', 'Delete Account Form',  '__return_false', 'wpwebapp_options_delete_account' );
		add_settings_section( 'security', 'Security',  '__return_false', 'wpwebapp_options_security' );
		...
		// Sign up form
		add_settings_field( 'signup_labels', __( 'Sign Up Labels', 'wpwebapp' ), 'wpwebapp_settings_field_signup_form_labels', 'wpwebapp_options_signup', 'signup' );
		add_settings_field( 'signup_submit', __( 'Sign Up Submit Button', 'wpwebapp' ), 'wpwebapp_settings_field_signup_form_submit', 'wpwebapp_options_signup', 'signup' );
		add_settings_field( 'signup_requirements', __( 'Sign Up Password Requirements', 'wpwebapp' ), 'wpwebapp_settings_field_signup_form_show_requirements', 'wpwebapp_options_signup', 'signup' );
		add_settings_field( 'signup_errors', __( 'Sign Up Errors', 'wpwebapp' ), 'wpwebapp_settings_field_signup_form_errors', 'wpwebapp_options_signup', 'signup' );
		add_settings_field( 'signup_notifications_to_admin', __( 'Sign Up Admin Notifications', 'wpwebapp' ), 'wpwebapp_settings_field_signup_form_notifications_to_admin', 'wpwebapp_options_signup', 'signup' );
		add_settings_field( 'signup_notifications_to_user', __( 'Sign Up User Notifications', 'wpwebapp' ), 'wpwebapp_settings_field_signup_form_notifications_to_user', 'wpwebapp_options_signup', 'signup' );
		add_settings_field( 'create_user_password_time_valid', __( 'User Password Time Limit', 'wpwebapp' ), 'wpwebapp_settings_field_create_user_password_time_limit', 'wpwebapp_options_signup', 'signup' );
		add_settings_field( 'create_user_notifications', __( 'Create User Notifications', 'wpwebapp' ), 'wpwebapp_settings_field_create_user_notifications_to_user', 'wpwebapp_options_signup', 'signup' );

		// Login form
		add_settings_field( 'login_labels', __( 'Login Labels', 'wpwebapp' ), 'wpwebapp_settings_field_login_form_labels', 'wpwebapp_options_login', 'login' );
		add_settings_field( 'login_submit', __( 'Login Submit Button', 'wpwebapp' ), 'wpwebapp_settings_field_login_form_submit', 'wpwebapp_options_login', 'login' );
		add_settings_field( 'login_errors', __( 'Login Errors', 'wpwebapp' ), 'wpwebapp_settings_field_login_form_errors', 'wpwebapp_options_login', 'login' );

		// Redirects
		add_settings_field( 'redirects', __( 'Redirect URLs', 'wpwebapp' ), 'wpwebapp_settings_field_login_logout_redirects', 'wpwebapp_options_redirects', 'redirects' );

		// Email change form
		add_settings_field( 'email_change_labels', __( 'Email Change Labels', 'wpwebapp' ), 'wpwebapp_settings_field_email_change_form_labels', 'wpwebapp_options_change_email', 'email_change' );
		add_settings_field( 'email_change_submit', __( 'Email Change Submit Buttons', 'wpwebapp' ), 'wpwebapp_settings_field_email_change_form_submit', 'wpwebapp_options_change_email', 'email_change' );
		add_settings_field( 'email_change_errors', __( 'Email Change Errors', 'wpwebapp' ), 'wpwebapp_settings_field_email_change_form_errors', 'wpwebapp_options_change_email', 'email_change' );

		// Password change form
		add_settings_field( 'password_change_labels', __( 'Change Password Labels', 'wpwebapp' ), 'wpwebapp_settings_field_password_change_form_labels', 'wpwebapp_options_change_password', 'password_change' );
		add_settings_field( 'password_change_submit', __( 'Change Password Submit Buttons', 'wpwebapp' ), 'wpwebapp_settings_field_password_change_form_submit', 'wpwebapp_options_change_password', 'password_change' );
		add_settings_field( 'password_change_show_requirements', __( 'Change Password Requirements', 'wpwebapp' ), 'wpwebapp_settings_field_password_change_form_show_requirements', 'wpwebapp_options_change_password', 'password_change' );
		add_settings_field( 'password_change_errors', __( 'Change Password Errors', 'wpwebapp' ), 'wpwebapp_settings_field_password_change_form_errors', 'wpwebapp_options_change_password', 'password_change' );
		add_settings_field( 'password_change_notifications_to_admin', __( 'Password Change Admin Notifications', 'wpwebapp' ), 'wpwebapp_settings_field_password_change_form_notifications_to_admin', 'wpwebapp_options_change_password', 'password_change' );
		add_settings_field( 'password_change_notifications_to_user', __( 'Password Change User Notifications', 'wpwebapp' ), 'wpwebapp_settings_field_password_change_form_notifications_to_user', 'wpwebapp_options_change_password', 'password_change' );

		// Forgot password form
		add_settings_field( 'password_reset_url', __( 'Forgot Password URL', 'wpwebapp' ), 'wpwebapp_settings_field_password_reset_url', 'wpwebapp_options_forgot_password', 'password_forgot' );
		add_settings_field( 'password_forgot_labels', __( 'Forgot Password Labels', 'wpwebapp' ), 'wpwebapp_settings_field_password_reset_form_labels', 'wpwebapp_options_forgot_password', 'password_forgot' );
		add_settings_field( 'password_forgot_submit', __( 'Forgot Password Submit Buttons', 'wpwebapp' ), 'wpwebapp_settings_field_password_reset_form_submit', 'wpwebapp_options_forgot_password', 'password_forgot' );
		add_settings_field( 'password_forgot_show_requirements', __( 'Forgot Password Requirements', 'wpwebapp' ), 'wpwebapp_settings_field_password_reset_form_show_requirements', 'wpwebapp_options_forgot_password', 'password_forgot' );
		add_settings_field( 'password_forgot_errors', __( 'Forgot Password Errors', 'wpwebapp' ), 'wpwebapp_settings_field_password_reset_form_errors', 'wpwebapp_options_forgot_password', 'password_forgot' );
		add_settings_field( 'password_forgot_timelimit', __( 'Forgot Password Time Limit', 'wpwebapp' ), 'wpwebapp_settings_field_password_reset_time_limit', 'wpwebapp_options_forgot_password', 'password_forgot' );
		add_settings_field( 'password_reset_notification', __( 'Password Reset Notification', 'wpwebapp' ), 'wpwebapp_settings_field_password_reset_notification_email', 'wpwebapp_options_forgot_password', 'password_forgot' );

		// Delete acccount form
		add_settings_field( 'delete_account_labels', __( 'Delete Account Labels', 'wpwebapp' ), 'wpwebapp_settings_field_delete_account_form_labels', 'wpwebapp_options_delete_account', 'delete_account' );
		add_settings_field( 'delete_account_submit', __( 'Delete Account Submit Buttons', 'wpwebapp' ), 'wpwebapp_settings_field_delete_account_form_submit', 'wpwebapp_options_delete_account', 'delete_account' );
		add_settings_field( 'delete_account_errors', __( 'Delete Account Errors', 'wpwebapp' ), 'wpwebapp_settings_field_delete_account_form_errors', 'wpwebapp_options_delete_account', 'delete_account' );
		add_settings_field( 'delete_account_redirect', __( 'Delete Account Redirect', 'wpwebapp' ), 'wpwebapp_settings_field_delete_account_form_redirect_url', 'wpwebapp_options_delete_account', 'delete_account' );

		// Security
		add_settings_field( 'security_password_length', __( 'Password Length', 'wpwebapp' ), 'wpwebapp_settings_field_password_length_requirements', 'wpwebapp_options_security', 'security' );
		add_settings_field( 'security_password_characters', __( 'Password Characters', 'wpwebapp' ), 'wpwebapp_settings_field_password_character_requirements', 'wpwebapp_options_security', 'security' );
		add_settings_field( 'security_show_admin_bar', __( 'Admin Bar', 'wpwebapp' ), 'wpwebapp_settings_field_show_admin_bar', 'wpwebapp_options_security', 'security' );
