...
function wpwebapp_plugin_options_render_page_pw_change() {
	...
	<div class="wrap">
		...
		<p><?php _e( 'Add a password change form to your app with a shortcode in your WordPress content editor or a function in your theme template files.', 'wpwebapp' ) ?></p>

		<ul>
			<li><?php _e( 'Shortcode', 'wpwebapp' ) ?>: <code>[wpwa_pw_change_form]</code></li>
			<li><?php _e( 'Function', 'wpwebapp' ) ?>: <code>&lt;?php echo wpwebapp_form_pw_change(); ?&gt;</code></li>
		</ul>
