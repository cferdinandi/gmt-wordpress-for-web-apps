...
function wpwebapp_plugin_options_init_alerts() {
	...
	add_settings_field( 'alert_username_invalid', __( 'Username Invalid', 'wpwebapp' ) . '<div class="description">' . __( 'Signup form', 'wpwebapp' ) . '</div>', 'wpwebapp_settings_field_alert_username_invalid', 'wpwebapp_plugin_options_alerts', 'alerts' );
